 ...
 *
 * This class represents the connection between application and database. It also has methods to close the
...
public class ConnectionFactory {
    ...
    private static final String DBURL = "jdbc:mysql://localhost:3306/schooldb3";
